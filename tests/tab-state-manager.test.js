...
test("aggregates privacy-preserving request, block, domain, and cosmetic statistics", async () => {
  ...
  assert.deepEqual(await manager.getPerformanceDiagnostics(), {
    ...
    cosmeticRootEscalations: 0,
    cosmeticContainmentChecks: 0,
    cosmeticFastSelectors: 0,
    cosmeticComplexSelectors: 0,
    proceduralBatchesProcessed: 0,
    proceduralMutationsProcessed: 0,
    proceduralRootsScanned: 0,
    proceduralNodesEvaluated: 0,
