...
OriginMatrix 1.24.0 was reviewed against remote-code execution, injection and XSS, unsafe HTML, parser and selector denial of service, scriptlet argument abuse, corrupted storage, malformed lists, custom-filter input, bounded selector generation, DNR rule exhaustion, and extension permissions.
