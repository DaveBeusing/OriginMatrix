...
export const UBLOCK_ADS = ublockList({ id: "ublock-ads", title: "uBlock filters – Ads", path: "filters/ublock-ads.txt", version: "20260810164418", updatedAt: "2026-08-10T16:44:18Z", sha256: "2f0618722b2a033fd2dd0d42d9b227f5491d4f4f90ab7a1122427fbf7e0315b6", filename: "filters.txt" });
export const UBLOCK_PRIVACY = ublockList({ id: "ublock-privacy", title: "uBlock filters – Privacy", path: "filters/ublock-privacy.txt", version: "20260811151633", updatedAt: "2026-08-11T15:16:33Z", sha256: "3a48ac48a6b0ed7d95d9a556db765c7543e62da46eb36344aec798da7fb2135f", filename: "privacy.txt" });
...
export const UBLOCK_UNBREAK = ublockList({ id: "ublock-unbreak", title: "uBlock filters – Unbreak", path: "filters/ublock-unbreak.txt", version: "20260810155226", updatedAt: "2026-08-10T15:52:26Z", sha256: "75be24d41ee6d18c509088c98b7464231e0faeb2a802ef85aedf7a7bf2fac7c8", filename: "unbreak.txt" });
...
function ublockList({ id, title, path, version, updatedAt, sha256, filename }) {
  return Object.freeze({ id, title, enabled: false, path, snapshotVersion: version, snapshotUpdatedAt: updatedAt, sha256, sourceUrl: `https://ublockorigin.github.io/uAssets/filters/${filename}`, licenseUrl: UASSETS_LICENSE });
}
