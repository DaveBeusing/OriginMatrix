...
export class FilterListService {
  constructor({ list, networkEngine, compiler = new NetworkFilterCompiler(), loadText }) {
  ...
  async activate() {
    ...
    try {
      ...
      this.state = statusFrom(this.list, {
        ...
        rulesUnsupported: parsed.diagnostics.rulesUnsupported + compiled.diagnostics.nonNetworkFilters,
